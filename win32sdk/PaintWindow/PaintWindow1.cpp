...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd){
    ...
    static TCHAR szWindowCaption[] = TEXT("Application");
    ...
    if(hWnd == NULL){
        MessageBox((HWND)NULL, TEXT("Failed to get handle hWnd"), TEXT("CreateWindowEx"), MB_ICONERROR);
        return (EXIT_FAILURE);
    }
...
LRESULT WINAPI WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam){
    ...
    switch(uMsg){
        ...
        case WM_PAINT:
            ...
            TextOutA(hdc, 0, 0, lpszMsg, nLength);
            EndPaint(hWnd, &ps);
            hdc = NULL;
            break;
