...
LPSTR glpCmdLine;
PSTRINGVECTOR gpStrVec;

int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nShowCmd)
{
    static TCHAR szClassName[] = TEXT("Standerd Window");
    ...
    MSG msg;
    ZeroMemory(&msg, sizeof(WNDCLASSEX));
    ...
    FAIL_EXIT_IF(hCursor == NULL, "Failed to get handle to cursor", "LoadCurso");
    ...
    hWnd = CreateWindowEx(
        ...
        szClassName,
        szWindowCaption,
        WS_MINIMIZEBOX | WS_MAXIMIZEBOX | WS_VSCROLL | WS_THICKFRAME | WS_CAPTION | WS_SYSMENU,
        CW_USEDEFAULT,
        CW_USEDEFAULT,
        CW_USEDEFAULT,
        CW_USEDEFAULT,
